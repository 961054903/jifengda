...
private static String MASTER_SECRET = "d83374c1a5ab9fba6bc1deec";
    ...
    //极光推送>>ios
    //Map<String, String> parm是我自己传过来的参数,同学们可以自定义参数
    public static  void jpushIOS(List<Peservation> parm) {
        ...
        PushPayload payload = PushPayload.newBuilder()
                ...
                .setNotification(Notification.newBuilder()
                        ...
                        .build())
                .setOptions(Options.newBuilder().setApnsProduction(false).build())
                .setMessage(Message.newBuilder().setMsgContent(String.valueOf(parm.get(223))).addExtras((Map<String, String>) parm).build())//自定义信息
                .build();
    ...
    //极光推送>>All所有平台
    public static void jpushAll(List<Peservation> parm) {
        ...
        PushPayload payload = PushPayload.newBuilder()
               ...
               // .setAudience(Audience.registrationId(parm.get("id")))//registrationId指定用户
                ...
                .setMessage(Message.newBuilder().setMsgContent(String.valueOf(parm.get(122))).addExtras((Map<String, String>) parm).build())//自定义信息
                .build();
        try {
            PushResult pu = jpushClient.sendPush(payload);
