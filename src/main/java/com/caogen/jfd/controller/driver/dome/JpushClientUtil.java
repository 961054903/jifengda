...
public class JpushClientUtil {
     ...
     * @param extrasParm   扩展字段
     * @return
     */
    public static int sendToAliasId(String aliasId, String notification_title, String msg_title, String msg_content, Map<String, Object> extrasParm) {
        int result = 0;
        try{
            PushPayload pushPayload = JpushClientUtil.buildPushObject_all_alias_alert(aliasId, notification_title, msg_title, msg_content, extrasParm);
    ...
    public static PushPayload buildPushObject_all_alias_alert(String aliasId, String notification_title, String msg_title, String msg_content, Map<String, Object> extrasParm) {
        return PushPayload.newBuilder()
                ...
                .setNotification(Notification.newBuilder()
                        ...
                        .addPlatformNotification(AndroidNotification.newBuilder()
                                ...
                                .addExtra("tagCode",extrasParm.get("tagCode").toString())
                                .addExtra("applyId",extrasParm.get("applyId").toString())
                ...
                .setMessage(Message.newBuilder()
                        ...
                        .addExtra("message extras key",extrasParm.get("tagCode").toString()+"|"+extrasParm.get("applyId").toString())
