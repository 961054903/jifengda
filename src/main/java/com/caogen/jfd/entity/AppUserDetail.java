...
public class AppUserDetail implements Serializable {
	...
	public AppUserDetail(Integer user_id, String title, String description, Type type, Double money,
	...
	public String toString() {
		return "AppUserDetail [id=" + id + ", user_id=" + user_id + ", title=" + title + ", description=" + description
				+ ", type=" + type + ", money=" + money + ", create_date=" + create_date + ", available=" + available
				+ "]";
	}
